...
export default function Edit({ kelas, gurus }: Props) {
    const { data, setData, processing, errors } = useForm({
        class: kelas.class,
        default_pic_id: kelas.default_pic_id?.toString() || '',
    });

    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        
        // Use router.put directly with transformed data
        router.put(route('admin.kelas.update', kelas.id), {
            class: data.class,
