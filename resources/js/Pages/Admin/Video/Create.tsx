...
export default function Create() {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        // Validasi video wajib diisi
        if (!data.video) {
            alert("Silakan pilih file video terlebih dahulu!");
            return;
        }

        router.post(route("admin.video.store"), data, {
            preserveScroll: true,
            forceFormData: true,
            onSuccess: () => {
                // Cleanup object URLs
                    ...
                    <form onSubmit={submit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Contoh: Video Edukasi - Komputer"
                                autoFocus
                                required
                            />
                            {errors.judul && (
                                    ...
                                    {videoPreview ? (
                                        ...
                                        <>
                                            ...
                                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                                atau drag and drop file video ke
                                                sini
                                            </p>
                                        </>
                                    )}
